...
export default async function LeaderboardPage() {
  ...
  const lastSyncLabel =
    latestPostedAt !== null
      ? formatSyncLabel(latestPostedAt)
      : "No snapshots yet";
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3 border-b border-white/5 pb-5">
                  ...
                  <span
                    className={`rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.35em] text-white/55`}
                  >
                ...
                <div className="mt-4 flex flex-col gap-3">
                  ...
                  <p className="text-sm font-medium text-white/80">
                    {formatPeriod(scope, snapshot)}
                  </p>
                  <p className="text-xs uppercase tracking-[0.35em] text-white/40">
                    Posted
                  </p>
                  <p className="text-sm text-white/75">
                    {formatPostedAt(snapshot)}
                  </p>
                </div>
                  ...
                  {snapshot && snapshot.entries.length > 0 ? (
                    ...
                    <div className="flex min-h-[160px] flex-col items-center justify-center gap-3 text-center text-sm text-white/55">
                      ...
                      <p className="text-xs text-white/35">
                        Snapshots appear automatically once the tracker posts to
                        Telegram.
                      </p>
                    </div>
                  )}

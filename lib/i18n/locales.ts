    ...
    dashboard: {
      ...
      features: {
        ...
        chat: {
          ...
          description: 'Делитесь успехами, поддерживайте друг друга и держите темп.',
        },
        motivation: {
        ...
        live: {
          ...
          description: 'Присоединяйтесь к фокус-румам и учитесь вместе в реальном времени.',
        },
        tasks: {
          title: 'Планировщик задач',
          description: 'Планируйте занятия, настраивайте блоки и фиксируйте приоритеты.',
        },
        timer: {
          title: 'Таймер',
        ...
        'research-positions': {
          ...
          description: 'Находите лаборатории и наставников, готовых принять амбициозных ребят.',
        },
        'internship-positions': {
          title: 'Стажировки',
          description: 'Подборка ролей, чтобы прокачать навыки и усилить резюме.',
        },
        'essay-workshop': {
          title: 'Эссе-воркшоп',
          description: 'Создавайте сильные личные истории с проверенными шаблонами.',
        },
        'universities-emails': {
          title: 'Письма университетам',
          description: 'Контакты приёмных комиссий и координаторов программ в одном месте.',
        },
        'hobbies-opportunities': {
        ...
        'olympiad-opportunities': {
          ...
          description: 'Следите за стартами и ресурсами подготовки к олимпиадам.',
        },
      },
    },
    motivation: {
  ...
  uz: {
    ...
    dashboard: {
      ...
      features: {
        leaderboard: {
          title: 'Reyting',
          description: "Eng faol qatnashchilarni kuzatib boring va fokus afsonalarini tabriklang.",
        },
        chat: {
          title: 'Hamjamiyat chat',
          description: 'Yangiliklar bilan o‘rtoqlashing, g‘alabalarni baham ko‘ring va birga intiling.',
        },
        motivation: {
          title: 'Motivatsiya xazinasi',
          description: 'Har kuni yangi iqtiboslar, fikrlar va muvaffaqiyat hikoyalari.',
        },
        live: {
          title: 'Jonli efir studiyasi',
          description: 'Fokus xonalariga qo‘shiling va real vaqt rejimida birga o‘qing.',
        },
        tasks: {
          title: 'Vazifa rejalashtirgich',
          description: 'Darslarni rejalang, bloklar yarating va kun tartibini mustahkamlang.',
        },
        timer: {
          title: 'Taymer',
        ...
        'research-positions': {
          ...
          description: 'Ambitsiyali hamkorlarni qidirayotgan laboratoriya va ustozlarni toping.',
        },
        'internship-positions': {
          title: 'Amaliyot imkoniyatlari',
          description: 'Ko‘nikmalarni charxlash va rezümengizni boyitish uchun tanlangan vakansiyalar.',
        },
        'essay-workshop': {
          title: 'Esse ustaxonasi',
          description: 'G‘olib arizalar uchun hikoyalarni kuchli asoslar bilan tuzing.',
        },
        'universities-emails': {
          title: 'Universitetlar kontaktlari',
          description: 'Qabul komissiyalari va dastur koordinatorlariga yozish uchun ma’lumotlar.',
        },
        'hobbies-opportunities': {
          title: 'Hobbi imkoniyatlari',
          description: 'Klublar, challenjlar va ijodiy loyihalar bilan muvozanatni saqlang.',
        },
        'olympiad-opportunities': {
          title: 'Olimpiadalar',
          description: 'Musobaqalar va tayyorgarlik resurslarini kuzatib boring.',
        },
      },
    },
    motivation: {
      ...
      rotationNote: 'Har kuni soat 00:00 (Toshkent) da yangi mantra paydo bo‘ladi.',

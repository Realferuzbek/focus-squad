...
export declare function resolveSessionRollingInterval(envMinutesValue?: string | number | null): number;
export declare function generateSessionId(byteLength?: number): string;
export declare function needsRollingRotation(lastIssuedAt: number | null | undefined, now: number, intervalMs?: number): boolean;
